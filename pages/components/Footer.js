    ...
    return (
        <footer>
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                    ...
                    <div className="sm:col-span-12 lg:col-span-3">
                        ...
                        <div className="text-sm text-gray-600">
                            <Link href="https://www.thryv.com/client-terms-of-use/">
                                <a className="hover:underline">Terms of Use</a>
                            </Link>
                            ·{" "}
                            <Link href="https://www.thryv.com/client-privacy-policy/">
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <a
                                    ...
                                    className="text-gray-600 hover:text-blue-500 transition duration-150 ease-in-out cursor-pointer"
                                >
                                    Home
                                </a>
                            </li>
                        ...
                        <ul className="text-sm">
                            <li className="mb-2">
                                <Link href="/commercial">
                                    <a className="text-gray-600 hover:text-blue-500 transition duration-150 ease-in-out">
                                        Commercial Plumbing
                                    </a>
                                </Link>
                            </li>
                    ...
                    {/* 4th block */}
                    <div className="sm:col-span-6 md:col-span-4 lg:col-span-3">
                        <h6 className="text-gray-800 font-medium mb-2">Find us on</h6>
                        <ul className="flex">
                            <li>
                                <Link
                                    href="#"
                                    ...
                                    aria-label="Twitter"
                                >
                                    <button className="flex text-gray focus:outline-none hover:text-white bg-white hover:bg-blue-500 rounded-full shadow transition duration-150 ease-in-out">
                                        <svg
                            ...
                            <li className="ml-2">
                                ...
                                >
                                    <button className="flex text-gray focus:outline-none hover:text-white bg-white hover:bg-blue-500 rounded-full shadow transition duration-150 ease-in-out">
                                        <svg class="svg-icon w-8 h-8 p-1" viewBox="0 0 20 20">
                                            <path
                                                fill="currentColor"
                ...
                {/* Copyright */}
                <div className="py-6 md:py-8 border-t border-gray-200 text-sm text-gray-600 text-center">
                    Tony & Son Plumbing Co . All rights reserved
                </div>
            </div>
        </footer>
    );
